...
class ControllerPaymentSuntechChinapay extends Controller {
	...
	public function index() {
		...
		$data['confirm'] = HTTP_CATALOG . 'index.php?route=payment/suntech_chinapay/confirm';
		...
		$data['action'] = $this->url->link('payment/suntech_chinapay', 'token=' . $this->session->data['token'], 'SSL');
		$data['cancel'] = $this->url->link('extension/payment', 'token=' . $this->session->data['token'], 'SSL');
		
		if (isset($this->request->post['suntech_chinapay_account'])) {
			$data['suntech_chinapay_account'] = $this->request->post['suntech_chinapay_account'];
		} else {
			$data['suntech_chinapay_account'] = $this->config->get('suntech_chinapay_account');
		}

		if (isset($this->request->post['suntech_chinapay_password'])) {
			$data['suntech_chinapay_password'] = $this->request->post['suntech_chinapay_password'];
		} else {
			$data['suntech_chinapay_password'] = $this->config->get('suntech_chinapay_password');
		}
		
		if (isset($this->request->post['suntech_chinapay_order_status_id'])) {
			$data['suntech_chinapay_order_status_id'] = $this->request->post['suntech_chinapay_order_status_id'];
		} else {
			$data['suntech_chinapay_order_status_id'] = $this->config->get('suntech_chinapay_order_status_id'); 
		} 
		...
		if (isset($this->request->post['suntech_chinapay_geo_zone_id'])) {
			$data['suntech_chinapay_geo_zone_id'] = $this->request->post['suntech_chinapay_geo_zone_id'];
		} else {
			$data['suntech_chinapay_geo_zone_id'] = $this->config->get('suntech_chinapay_geo_zone_id'); 
		} 
		...
		if (isset($this->request->post['suntech_chinapay_status'])) {
			$data['suntech_chinapay_status'] = $this->request->post['suntech_chinapay_status'];
		} else {
			$data['suntech_chinapay_status'] = $this->config->get('suntech_chinapay_status');
		}
		
		if (isset($this->request->post['suntech_chinapay_sort_order'])) {
			$data['suntech_chinapay_sort_order'] = $this->request->post['suntech_chinapay_sort_order'];
		} else {
			$data['suntech_chinapay_sort_order'] = $this->config->get('suntech_chinapay_sort_order');
		}
		...
		$this->response->setOutput($this->load->view('payment/suntech_chinapay.tpl', $data));
