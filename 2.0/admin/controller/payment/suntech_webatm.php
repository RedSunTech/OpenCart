...
class ControllerPaymentSuntechWebatm extends Controller {
	...
	public function index() {
		...
		// 交易成功接收網址
		$data['success'] = HTTP_CATALOG . 'index.php?route=payment/suntech_webatm/callback';
		// 交易失敗接收網址
		$data['error'] = HTTP_CATALOG . 'index.php?route=payment/suntech_webatm/callback';
		// 交易回傳確認網址 , 顯示 0000  （背景執行）
		$data['confirm'] = HTTP_CATALOG . 'index.php?route=payment/suntech_webatm/confirm';
