...
<div class="buttons" style="border: 1px solid #DDDDDD; border-top: 0px; padding: 10px; margin-bottom: 0px; <?php echo ($esafe_webatm_description == '') ? ' display:none;' : '';?>">
    <?php echo ($esafe_webatm_description == "") ? "" : $text_instruction . "<br /><font color='#FF9900'>" . $esafe_webatm_description . "</font><br />"; ?>
</div>
<div class="buttons">
